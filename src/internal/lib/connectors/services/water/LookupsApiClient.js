...
const getEndpoint = serviceUrl => urlJoin(serviceUrl, 'lookup');

class LookupsApiClient extends APIClient {
  /**
   * Create a new instance of a LookupsApiClient
...
module.exports = LookupsApiClient;
