...
const getTransactionData = trans => ({
  ...
  'S126 agreement (Y/N)': trans.calcS126FactorValue && parseFloat(trans.calcS126FactorValue) !== 1 ? 'Y' : 'N',
  'S126 agreement value': trans.calcS126FactorValue && parseFloat(trans.calcS126FactorValue) !== 1 ? trans.calcS126FactorValue : null,
