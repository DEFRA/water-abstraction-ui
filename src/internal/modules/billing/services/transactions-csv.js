...
function _csvLineSroc (invoice, invoiceLicence, transaction, chargeVersions) {
  const csvLine = {
    ...
    'Base charge': transaction.grossValuesCalculated.baselineCharge,
    ...
    'Public water supply additional charge': transaction.grossValuesCalculated.waterCompanyCharge,
    'Supported source Y/N': transaction.isSupportedSource ? 'Y' : 'N',
    'Supported source name': transaction.supportedSourceName,
    'Supported source additional charge': transaction.grossValuesCalculated.supportedSourceCharge,
