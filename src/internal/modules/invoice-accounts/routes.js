...
if (config.featureToggles.manageInvoiceAccounts) {
  module.exports = {
    ...
    getContactEntered: { // This route is intended to act as a redirection utility. When users reach the end of the `contact-entry` workflow, they will be redirected to this GET request.
      method: 'GET',
      path: '/invoice-accounts/create/{regionId}/{companyId}/contact-entered',
      handler: controller.getContactEntered,
      config: {
        auth: { scope: allowedScopes },
