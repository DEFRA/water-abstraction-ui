...
const { ADD_DATA, EDIT_DATA, DELETE_DATA } = require('../../../../../src/external/modules/abstraction-reform/lib/action-types');
const { createAddData, createEditData, createDeleteData } = require('../../../../../src/external/modules/abstraction-reform/lib/action-creators');
...
lab.experiment('Test createEditData action creator', () => {
  ...
  const action = createEditData(data, user, id);
