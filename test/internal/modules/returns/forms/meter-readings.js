...
const { schema: meterReadingsSchema, form: meterReadingsForm } = require('internal/modules/returns/forms/meter-readings');
...
experiment('meterReadingsForm', () => {
  ...
  test('label is shown for internal user', async () => {
    const request = createRequest();
    const form = meterReadingsForm(request, data);
