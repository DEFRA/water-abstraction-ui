...
const loader = require('../../../../src/modules/abstraction-reform/lib/loader.js');
const formGenerator = require('../../../../src/modules/abstraction-reform/lib/form-generator.js');
...
lab.experiment('getAddFormAndSchema', () => {
  ...
  lab.test('The form should have the correct action attribute', async () => {
    expect(result.form.action).to.equal(`/admin/abstraction-reform/licence/${request.params.documentId}/add-data/${request.params.schema}`);
  });
...
lab.experiment('getEditFormAndSchema', () => {
  ...
  lab.test('The form should have the correct action attribute', async () => {
    expect(result.form.action).to.equal(`/admin/abstraction-reform/licence/${request.params.documentId}/edit-data/${id}`);
  });
